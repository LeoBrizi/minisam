...
void minimum_degree_ordering_patched(SparseMatrix<Scalar,ColMajor,StorageIndex>& C, PermutationMatrix<Dynamic,Dynamic,StorageIndex>& perm)
{
  using std::sqrt;
  
  long d, dk, dext, lemax = 0, e, elenk, eln, i, j, k, k1,
...
#endif // EIGEN_SPARSE_AMD_PATCHED_H
